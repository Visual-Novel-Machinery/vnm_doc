---
layout: single
title: Scene Background Play Animation
permalink: /docs/nodes-references/scene-background-play-animation
toc: true
sidebar:
  nav: "docs"
---
...
![Scene Background Play Animation Node Visual]({{ site.baseurl }}/assets/images/NodeReference/scene-background-play-animation.png)
